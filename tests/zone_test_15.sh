...
echo "*********************************************************************"
echo "Begin DevStack Exercise: L2TPv3 between 2 VMs add remove tunnel ($0)"
echo "*********************************************************************"
...
if ip_execute_cmd $IP1 "ping6 -c3 $ZONE_IP2"; then
    die $LINENO "Failure ping shouldnot pass yer"
fi
...
check_zone_port_binding_tunnel $ZONE_PORT_ID2
